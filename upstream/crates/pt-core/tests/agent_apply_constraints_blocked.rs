...
#[test]
fn agent_apply_uses_top_class_posterior_for_constraints() {
    with_temp_data_dir(|dir| {
        ...
        let identity = ProcessIdentity {
            pid: ProcessId(pid),
            start_id: StartId("boot:1:424244".to_string()),
            uid: 1000,
            pgid: None,
            sid: None,
...
fn agent_apply_returns_policy_blocked_for_constraints() {
    with_temp_data_dir(|dir| {
        ...
        let identity = ProcessIdentity {
            pid: ProcessId(pid),
            start_id: StartId("boot:1:424243".to_string()),
            uid: 1000,
            pgid: None,
            sid: None,
            quality: IdentityQuality::Full,
